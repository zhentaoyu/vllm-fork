#!/bin/bash
# This file demonstrates the example usage of disaggregated prefilling with loading
# chunk rag kv cache (concat and re-rope)
# We will launch 2 vllm instances (1 for prefill and 1 for decode),
# and then transfer the KV cache between them.
# test steps:
#
# 1. send system_prompt, search_results_0, search_result_1, ..., search_result_n respectively
# and save their kv cache into disk
...
# ### Question: {question} \n
# ### Answer:
# the context in Search results is composed of several retrieval contents
#
...
rag_0=" In a world where technology has advanced beyond our wildest dreams, humanity stands \
...
and corporations race to secure their own quantum capabilities, sparking a new kind of arms race."

rag_1=" Meanwhile, a group of rogue programmers, known as the Shadow Collective, seeks to exploit the technology \
for their own ends. As tensions rise, a young scientist named Dr. Evelyn Zhang finds herself at the center of this \
...
that once thrived on traditional industries find themselves struggling to adapt."

rag_2=" The digital divide grows wider, creating new forms of inequality. Dr. Zhang's journey is not just \
a scientific quest but a deeply personal one. Her motivations are shaped by a desire to honor her late \
father's legacy, a pioneer in the field of AI who envisioned a future where technology would serve humanity's \
highest ideals. As she delves deeper into her research, she encounters allies and adversaries from unexpected \
...
echo ""
echo "saved system_prompt: ${saved_system_prompt}"
sleep 1
...
echo ""
echo "saved rag_1: ${saved_rag_1}"
echo "========================================================================================="
sleep 1

saved_rag_2="${rag_2}${prompt_prefix}"
output1=$(curl -s http://localhost:8000/v1/completions \
-H "Content-Type: application/json" \
-d @- <<EOF
{
